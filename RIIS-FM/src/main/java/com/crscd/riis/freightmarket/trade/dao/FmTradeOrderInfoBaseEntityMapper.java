...
public interface FmTradeOrderInfoBaseEntityMapper {
    ...
    @Results({
        ...
        @Result(column="C_RECVER_NAME", property="cRecverName", jdbcType=JdbcType.VARCHAR),
    ...
    @Insert({
        ...
        "D_PREDICT_LOAD_END_TIME, C_RECVER_NAME, ",
        "C_RECVER_ADDRESS, C_RECVER_PHONE, ",
        "C_RECVER_EMAIL, C_RECVER_POSTCODE, ",
        "C_RECVER_CITY, C_UNLOAD_STATION, ",
        "C_UNLOAD_LOCATION, C_ORDER_TYPE, ",
        "I_ORDER_STATE, I_ORDER_SPLITE, ",
        "D_ORDER_CREATE_TIME, D_ORDER_END_TIME, ",
        "D_ORDER_TEMMINATE_TIME, I_ORDER_TEMMINATE, ",
        "I_ORDER_DELETE, D_ORDER_DELETE_TIME, ",
        "D_ORDER_ALTER_TIME, C_ACCESS_CODE, ",
        "I_LOGISTICS_TYPE, F_PROTECT_PRICE, ",
        "F_INSURANCE_VALUE)",
        "values (#{id,jdbcType=INTEGER}, #{cOrderCode,jdbcType=VARCHAR}, ",
        "#{iOrderTypeId,jdbcType=INTEGER}, #{dOrderDateline,jdbcType=DATE}, ",
        ...
        "#{dPredictLoadEndTime,jdbcType=TIMESTAMP}, #{cRecverName,jdbcType=VARCHAR}, ",
        "#{cRecverAddress,jdbcType=VARCHAR}, #{cRecverPhone,jdbcType=VARCHAR}, ",
        "#{cRecverEmail,jdbcType=VARCHAR}, #{cRecverPostcode,jdbcType=VARCHAR}, ",
        "#{cRecverCity,jdbcType=VARCHAR}, #{cUnloadStation,jdbcType=VARCHAR}, ",
        "#{cUnloadLocation,jdbcType=VARCHAR}, #{cOrderType,jdbcType=VARCHAR}, ",
        "#{iOrderState,jdbcType=INTEGER}, #{iOrderSplite,jdbcType=INTEGER}, ",
        "#{dOrderCreateTime,jdbcType=TIMESTAMP}, #{dOrderEndTime,jdbcType=TIMESTAMP}, ",
        "#{dOrderTemminateTime,jdbcType=TIMESTAMP}, #{iOrderTemminate,jdbcType=INTEGER}, ",
        "#{iOrderDelete,jdbcType=INTEGER}, #{dOrderDeleteTime,jdbcType=TIMESTAMP}, ",
        "#{dOrderAlterTime,jdbcType=TIMESTAMP}, #{cAccessCode,jdbcType=VARCHAR}, ",
        "#{iLogisticsType,jdbcType=INTEGER}, #{fProtectPrice,jdbcType=REAL}, ",
        "#{fInsuranceValue,jdbcType=REAL})"
    })
    ...
    @Results({
        ...
        @Result(column="C_ORDER_CODE", property="cOrderCode", jdbcType=JdbcType.VARCHAR),
        @Result(column="I_ORDER_TYPE_ID", property="iOrderTypeId", jdbcType=JdbcType.INTEGER),
        @Result(column="D_ORDER_DATELINE", property="dOrderDateline", jdbcType=JdbcType.DATE),
        @Result(column="I_USER_TYPE", property="iUserType", jdbcType=JdbcType.INTEGER),
        @Result(column="I_SENDER_ID", property="iSenderId", jdbcType=JdbcType.INTEGER),
        @Result(column="I_RECVER_ID", property="iRecverId", jdbcType=JdbcType.INTEGER),
        @Result(column="I_SENDER_OPERATOR_ID", property="iSenderOperatorId", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        ...
        "D_PREDICT_LOAD_END_TIME, C_RECVER_NAME, C_RECVER_ADDRESS, C_RECVER_PHONE, C_RECVER_EMAIL, ",
        "C_RECVER_POSTCODE, C_RECVER_CITY, C_UNLOAD_STATION, C_UNLOAD_LOCATION, C_ORDER_TYPE, ",
        "I_ORDER_STATE, I_ORDER_SPLITE, D_ORDER_CREATE_TIME, D_ORDER_END_TIME, D_ORDER_TEMMINATE_TIME, ",
    ...
    @Select({
        ...
        "C_SENDER_PHONE, C_SENDER_EMAIL, C_SENDER_POSTCODE, C_SENDER_NOTE, C_SENDER_CITY, ",
        "C_LOAD_STATION, C_LOAD_LOCATION, D_PREDICT_SEND_TIME, D_PREDICT_LOAD_START_TIME, ",
        "D_PREDICT_LOAD_END_TIME, C_RECVER_NAME, C_RECVER_ADDRESS, C_RECVER_PHONE, C_RECVER_EMAIL, C_RECVER_POSTCODE, ",
    ...
    @Update({
        ...
        "set C_ORDER_CODE = #{cOrderCode,jdbcType=VARCHAR},",
          ...
          "D_ORDER_DATELINE = #{dOrderDateline,jdbcType=DATE},",
          ...
          "C_RECVER_NAME = #{cRecverName,jdbcType=VARCHAR},",
